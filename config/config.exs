...
#### General configuration useful for tests, everything else should be in `bonfire_poll.exs` or `Bonfire.Poll.RuntimeConfig`
...
config :bonfire_poll, :otp_app, :bonfire_poll
...
import_config "bonfire_poll.exs"
